	...
	<div class="infoList">
		<div class="info__wrapper">
			<div class="info current--info">
				<h1 class="text name">Product1</h1>
				<h4 class="text location">subtitle</h4>
				<p class="text description">description</p>
			</div>

			<div class="info next--info">
				<h1 class="text name">product2</h1>
				<h4 class="text location">subtitle</h4>
				<p class="text description">description</p>
			</div>

			<div class="info previous--info">
				<h1 class="text name">product3</h1>
				<h4 class="text location">subtitle</h4>
				<p class="text description">description</p>
			</div>
		</div>
...
export default {
  ...
  data: () => ({
    img1: require('../assets/pic/pic-product.jpg'),
    img2: require('../assets/pic/beauty-mec.jpg'),
    img3: require('../assets/pic/vertical-linedup.jpg'),
  }),
};
</script>
